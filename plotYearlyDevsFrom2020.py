...
# -*- coding: utf-8 -*-
"""
Creates plots of the yearly deviations from 2020 for each sensor
"""
...
for i,sensor_pair in enumerate(Sensors):
    ...
    for data_type in ['PM1.0_CF1_ug/m3','PM2.5_CF1_ug/m3','PM10.0_CF1_ug/m3','Temperature_F']:
        ...
        plotting.yearlyPlot(A, sensorname+"Yearly Dev From 2020 "+data_type_name, data_type)